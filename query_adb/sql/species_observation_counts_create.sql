...
DROP TABLE IF EXISTS species_observation_counts;
CREATE TABLE species_observation_counts AS
...
DROP TABLE IF EXISTS species_observation_counts_filters;
CREATE TABLE species_observation_counts_filters (
filter_name text,
filter text
);
