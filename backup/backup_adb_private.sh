...
#########################################################################
# Purpose:	Backs up production schema of analytical database
#
...
pname_custom="Backup adb private"
...
# Dump schema contents from source database
