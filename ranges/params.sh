...
# Table name
# Source and target must be the same name
#tbl="testtbl"
tbl="ranges"

# Set source database and schema
src_db=$db_public
src_schema=$prod_schema_adb_public

# Set target database and schema
target_db=$db_private
#target_schema=$prod_schema_adb_private
target_schema=$dev_schema_adb_private

# Short name for this operation, for screen echo and 
# notification emails
pname_local="Copy table ranges"
