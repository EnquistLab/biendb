-- ---------------------------------------------------------
-- Update nsr results columns to copy of table analytical_stem
...
-- columns.
-- NSR results are from vfoi because astem is 
-- a subset of vfoi
DROP TABLE IF EXISTS analytical_stem_new;
CREATE TABLE analytical_stem_new AS 
SELECT 
...
-- WHERE clause not a mistake--uses same nsr results as vfoi!
