...
-- DEACTIVATING, NOT SURE HOW, BUT A DUPLICATE RECORD 'HVAA','HVAA' 
-- IS CREEPING IN AND CAUSING THIS INDEXING STEP TO FAIL
-- Unique index on candidate PK
-- Prevents adding duplicate source + proximate_provider
-- DROP INDEX IF EXISTS datasource_source_name_proximate_provider_name_idx;
-- CREATE UNIQUE INDEX datasource_source_name_proximate_provider_name_idx ON datasource(source_name, proximate_provider_name);
