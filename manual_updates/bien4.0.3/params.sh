...
# Hotfix number
# This should be the same as the updated db version number that will be
# applied after hotfix completed
hf_num="4.0.3"

# Hotfix files directory
hf_dir="sql_hf_"$hf_num

# Set target database and schema
#curr_db=$db_private
#curr_sch=$prod_schema_adb_private
curr_db=$db_public
curr_sch=$prod_schema_adb_public
