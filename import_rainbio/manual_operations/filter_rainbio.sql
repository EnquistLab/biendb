...
-- datasource 'rainbio' that are from non-public datasets. Not part of 
-- import pipeline. Should be added to public embargo pipeline.
-- 
-- NOTE 1: To be applied to PUBLIC database, not private
-- 
-- NOTE 2: vfoi.catalog_number MUST be indexed for operation that
-- populates rainbio_embargoes or this will be extremely slow!
-- 
-- NOTE 3: All indexes should be removed from vfoi, astem and agg_traits
