...
PGOPTIONS='--client-min-messages=warning' psql -U $user -d $db_private --set ON_ERROR_STOP=1 -q -v dev_schema=$dev_schema_adb_private -f $DIR_LOCAL/sql/update_vfoi_specimens_remove_nonplots.sql
