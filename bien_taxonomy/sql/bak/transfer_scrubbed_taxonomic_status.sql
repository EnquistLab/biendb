-- ----------------------------------------------------------------
-- Transfers contents of bien_taxonomy.scrubbed_taxonomic_status 
-- back to table view_full_occurrence_individual_dev. 
-- 
-- Ultimately, scrubbed taxonomic status should already be 
-- populated in vfoi. Skip this step when this omission has 
-- been fixed.
-- ----------------------------------------------------------------
...
-- Note that all columns except scrubbed_taxonomic_status
-- come from table 'a'
...
FROM view_full_occurrence_individual_temp a JOIN bien_taxonomy_dev b
