--
-- Drop all indexes and constraints on vfoi_dev
-- 

SET search_path TO :sch;

-- Various ways PK might be referenced
-- Must drop constraints, if any, first
ALTER TABLE view_full_occurrence_individual_dev DROP CONSTRAINT IF EXISTS vfoi_pkey;
ALTER TABLE view_full_occurrence_individual_dev DROP CONSTRAINT IF EXISTS view_full_occurrence_individual_pkey;
...
-- Drop spatial constraints and indexes
