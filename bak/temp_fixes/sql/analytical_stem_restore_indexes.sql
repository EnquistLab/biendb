...
DROP INDEX IF EXISTS analytical_stem_taxonomic_status_idx;
...
CREATE INDEX analytical_stem_taxonomic_status_idx ON analytical_stem USING btree (taxonomic_status);
CREATE INDEX analytical_stem_matched_taxonomic_status_idx ON analytical_stem USING btree (matched_taxonomic_status);
