...
-- Important for later pruning in shell
UPDATE tnrs_submitted
SET name_submitted=TRIM(name_submitted)
...
-- Finally, delete any name *not* beginning with a letter, double quotes or 
-- single quotes. These wreak havoc on the TNRS and are hard to match back
-- to original table and anyways are almost always crap
