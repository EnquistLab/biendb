...
SELECT * FROM public.bien_summary;
...
-- Adjust permissions
--
REVOKE ALL ON TABLE bien_summary FROM PUBLIC;
REVOKE ALL ON TABLE bien_summary FROM bien;
GRANT ALL ON TABLE bien_summary TO bien;
ALTER TABLE bien_summary OWNER TO bien;
GRANT SELECT ON TABLE bien_summary TO public_bien;
GRANT SELECT ON TABLE bien_summary TO public_bien3;
