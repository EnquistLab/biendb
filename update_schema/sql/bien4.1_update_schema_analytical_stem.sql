...
ALTER TABLE analytical_stem RENAME TO analytical_stem_temp;
...
CREATE INDEX analytical_stem_taxonobservation_id_idx ON analytical_stem_temp (taxonobservation_id);
...
-- columns.
CREATE TABLE analytical_stem AS 
SELECT 
