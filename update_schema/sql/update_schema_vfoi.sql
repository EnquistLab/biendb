...
-- DROP INDEX IF EXISTS view_full_occurrence_individual_temp_fk_tnrs_id_idx;
-- CREATE INDEX view_full_occurrence_individual_temp_fk_tnrs_id_idx ON view_full_occurrence_individual_temp (fk_tnrs_id);
