...
data_dir_local_abs="/home/boyle/bien3/phylogeny/data"

# Metadata file
meta_file="phylo_info_utf8.csv"

# Phylogeny file suffix
# All phylogeny files, and *only* the phylogeny files, should have this 
# suffix, otherwise script will fail
phylo_file_suffix="tre"
