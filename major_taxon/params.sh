...
# External table import parameters. 
src_tbl='ncbi_taxa'		# Table to be imported
src_db='ncbi'				# Database where table is found
...
data_dir_local_abs="/home/boyle/bien3/analytical_db/private/data/major_taxon"
