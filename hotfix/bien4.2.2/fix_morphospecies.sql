...
--
-- Troubleshooting (private db)
--

/c vegbien
set search_path to analytical_db;

-- Compare current and revised
SELECT DISTINCT 
...
END
AS morphospecies_revised
FROM 
--analytical_stem
view_full_occurrence_individual
WHERE datasource='SALVIAS'
AND plot_name='c1000-1'
-- AND plot_name='YANAMTAH'
ORDER BY scrubbed_family, morphospecies_revised
;
